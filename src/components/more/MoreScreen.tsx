  ...
  const modules = [
    {
      ...
      desc: 'Lightweight concept incubator (Idea → Maybe → Planned)',
      icon: Lightbulb,
    ...
    },
    {
      ...
      desc: 'Study roadmap, architecture cheat-sheets, notes',
      icon: BookOpen,
    ...
    },
    {
      ...
      label: 'Decisions Log',
      desc: 'Architectural and product choices with rationale',
      icon: Scale,
    ...
    <div className="space-y-5 pb-20 md:pb-8">
      ...
      <div className="pt-1">
        ...
        <p className="text-xs text-zinc-500 dark:text-zinc-400">
          Ideas, knowledge hub, decisions log, and workspace settings
        </p>
      </div>
      ...
      <div className="rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 p-4 space-y-3">
        <div className="flex items-center gap-2">
          ...
          <h3 className="text-xs font-bold uppercase tracking-wider text-zinc-900 dark:text-zinc-100">
            Workspace Collaborators (2 Users)
          </h3>
        </div>
